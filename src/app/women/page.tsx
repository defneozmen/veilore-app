...
export default function WomenPage() {
  ...
  // NOT: Context dosyanızda silme fonksiyonunun adı 'removeProduct' değilse (örn: deleteProduct), burayı değiştirin.
    ...
    <div style={{ backgroundColor: "#fffbfc", minHeight: "100vh" }} className="py-5">
      <div className="container">
        ...
        <div className="text-center mb-5">
          <h2 className="display-6 fw-bold text-dark" style={{ color: "#be185d" }}>
            Kadın Koleksiyonu
          </h2>
        ...
        <div className="row g-4">
          {womenProducts.map((product) => (
            // Her kartı bir kolon içine alıyoruz (col-md-3 vs. ProductCard içinde de olabilir ama bu yapı daha güvenli)
          ...
          {womenProducts.length === 0 && (
             <div className="col-12 text-center py-5">
                ...
                <h3>Henüz kadın kategorisinde ürün yok.</h3>
